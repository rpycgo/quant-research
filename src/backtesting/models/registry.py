...
_REGISTRY: dict[str, ModelEntry] = {
    ...
    "mdrs_sde_btc":              ModelEntry(MdrsSdeCryptoAdapter, requires_event_tagging=True),
    "mdrs_sde_eth":              ModelEntry(MdrsSdeCryptoAdapter, requires_event_tagging=True),
    "mdrs_sde_sol":              ModelEntry(MdrsSdeCryptoAdapter, requires_event_tagging=True),
    "mdrs_sde_xrp":              ModelEntry(MdrsSdeCryptoAdapter, requires_event_tagging=True),
    # GARCH
